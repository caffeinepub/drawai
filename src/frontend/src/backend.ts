...
export class Backend implements backendInterface {
    ...
    async fetchWikipediaSummary(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchWikipediaSummary(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async incrementCompletedCount(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.incrementCompletedCount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveTutorial(arg0: string, arg1: Array<TutorialStep>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveTutorial(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");

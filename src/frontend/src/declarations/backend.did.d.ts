...
export interface TutorialStep { 'description' : string }
...
export interface _SERVICE {
  ...
  'fetchWikipediaSummary' : ActorMethod<[string], string>,
  'getAllFeedback' : ActorMethod<[], Array<Feedback>>,
  'getAllTutorials' : ActorMethod<[], Array<Tutorial>>,
  'incrementCompletedCount' : ActorMethod<[string], bigint>,
  'saveTutorial' : ActorMethod<[string, Array<TutorialStep>], undefined>,

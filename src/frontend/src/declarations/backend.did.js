...
export const TutorialStep = IDL.Record({ 'description' : IDL.Text });
export const Tutorial = IDL.Record({
  'subject' : IDL.Text,
  'completedCount' : IDL.Nat,
  'steps' : IDL.Vec(TutorialStep),
});
...
export const idlService = IDL.Service({
  ...
  'fetchWikipediaSummary' : IDL.Func([IDL.Text], [IDL.Text], []),
  'getAllFeedback' : IDL.Func([], [IDL.Vec(Feedback)], ['query']),
  'getAllTutorials' : IDL.Func([], [IDL.Vec(Tutorial)], ['query']),
  'incrementCompletedCount' : IDL.Func([IDL.Text], [IDL.Nat], []),
  'saveTutorial' : IDL.Func([IDL.Text, IDL.Vec(TutorialStep)], [], []),
...
export const idlFactory = ({ IDL }) => {
  ...
  const TutorialStep = IDL.Record({ 'description' : IDL.Text });
